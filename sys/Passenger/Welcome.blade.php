    <div class="card mb-5 mb-xl-8 shadow-xl">
        ...
        <div class="card-body pb-0">
            ...
            <div class="mb-7">
                <!--begin::Text-->
                <div class="text-gray-800 mb-5">Hello {{ Auth::user()->name }}. To complete the process of filling the
                    PIR, Please fill in the passenger information below</div>
                <!--end::Text-->
                <!--begin::Toolbar-->
                <div class="d-flex align-items-center mb-5">
            ...
            <button type="submit" class="btn btn-dark float-end my-3">Next Step</button>
            <!--end::Separator-->
            <!--begin::Reply input-->
